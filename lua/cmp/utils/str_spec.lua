...
describe('utils.str', function()
  ...
  it('correctly handle macro and snippets from #rust analyzer', function()
    assert.are.equal(str.get_word('print($0)', nil, 4), 'print')
    assert.are.equal(str.get_word('print!($0)', nil, 5), 'print!')
    assert.are.equal(str.get_word('Option<$0>', nil, 6), 'Option')
    assert.are.equal(str.get_word('Result<$0>', nil, 6), 'Result')
  end)
end)
